...
OPEN_WALLET_PATH = "/api/v1/stock-wallet"
...
def create_stock_wallet(access_token: str, stock_id: int):
    url = f"{BASE_URL}{OPEN_WALLET_PATH}"
    headers = {"Authorization": f"Bearer {access_token}"}
    json_data = {"stock_id": stock_id}
...
if __name__ == "__main__":
    ...
    for i, u in enumerate(users, start=1):
        ...
        ok, code, note = create_stock_wallet(access_token, 1)  # stock_id = 1
